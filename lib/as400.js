...
define(['underscore', 'lib/taskutil', 'lib/couchutil', 'app/js/codici', 'lib/inventario', 'dbconfig'], function (_, taskutil, couchutil, codici, inventario, dbconfig) {
  'use strict';
  ...
  function newInventario(codiceAzienda, numero, tipoMagazzino, inProduzione, rows) {
    ...
    movimentoMagazzino.verificato = 1;
