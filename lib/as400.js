...
define(['underscore', 'lib/taskutil', 'lib/couchutil', 'app/js/codici'], function (_, taskutil, couchutil, codici) {
  ...
  function buildInventarioTipo1As400(azienda, taglieScalarini, modelliEScalarini, inventarioOrdet00fAs400) {
    ...
    for (; i < n; i += 1) {
      ...
      if (!desscal) {
        ...
        for (j = 0, l = taglie.length; j < l; j += 1) {
          ...
          if (qta) {
            inventario.push([stagione + modello + articolo + colore + taglia, qta, azienda, pronto, 1]);
          }
        }
      }
    }
  ...
  function newBuilderInventarioTipo1As400(azienda, taglieScalarini, modelliEScalarini) {
    return function (inventarioOrdet00fAs400) {
      return buildInventarioTipo1As400(azienda, taglieScalarini, modelliEScalarini, inventarioOrdet00fAs400);
    };
  }
          ...
          doInventario = function () {
            ...
            if (azienda.tipo === 'NEGOZIO' || (azienda.tipo === 'MAGAZZINO' && !azienda.codiceMagazzino)) {
              fetchFromAs400(as400Querier, ['ordet00f', 'codiceCliente=' + codice],
                newBuilderInventarioTipo1As400(codice, taglieScalarini, modelliEScalarini),
                appendInventario);
