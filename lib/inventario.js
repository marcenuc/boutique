/*global define:false*/
define(['nano', 'lib/servers', 'dbconfig', 'views/lib/codici', 'lib/couchutil'], function (nano, servers, dbconfig, codici, couchutil) {
  'use strict';
  ...
  function update(callback) {
    ...
    db.view(dbconfig.designDoc, 'giacenze', { group_level: 10 }, function (err, giacenze) {
      if (err) {
        return callback(err);
      }
